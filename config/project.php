...
return [
    ...
    // 官网
    'website' => [
        'name' => env('project.web_name', 'chatAdmin'), // 网站名称
        'url' => env('project.web_url', '/'), // 网站地址
        'login_image' => 'resource/image/adminapi/default/login_image.png',
        'customer_service_login_image' => 'resource/image/adminapi/default/login_image.png',
    ...
    // 唯一标识，密码盐、路径加密等
    'unique_identification' => env('project.unique_identification', 'chat_admin'),
